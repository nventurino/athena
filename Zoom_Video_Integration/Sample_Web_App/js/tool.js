var testTool = {
  ...
  getMeetingConfig: function() {
    var account_sdkkey = document.getElementById('account_sdkkey').value;
    var account_sdksecret = document.getElementById('account_sdksecret').value;
    if (!account_sdkkey || !account_sdksecret) {
      account_sdkkey = document.getElementById('meeting_account').value;
      account_sdksecret = '';
    }
    else {
      account_sdksecret = document.getElementById('account_sdksecret').value;
    }
    console.log(account_sdkkey, account_sdksecret)
    console.log(account_sdkkey);
    if(!document.getElementById('meeting_topic').value) {
      alert("topic can't empty");
      return;
    }
    return{
      apiKey: account_sdkkey,
      apiSecret:  account_sdksecret,
      ...
      web: document.getElementById('meeting_web').value,
      email: testTool.b64EncodeUnicode(document.getElementById('meeting_email').value),
      version: document.getElementById('websdk_version').value,
      lang: document.getElementById('meeting_lang').value,
      signature: '',
      china: document.getElementById('meeting_china').value,
      topic: testTool.b64EncodeUnicode(document.getElementById('meeting_topic').value),
    };
  },
  ...
  generateEmail: function() {
    var tmpEmail = testTool.randomNum(1000, 9999) +
      testTool.detectOS() +
      testTool.getBrowserInfo()[0].split('\.')[0].replace("/", "") +
      "@zoom.us";
    return tmpEmail;
  },
}
